...
public class CommandContext(TextWriter standardWriter, TextWriter errorWriter)
{
    ...
    private void PrintErrorsWithHeader(IEnumerable<string> errors)
    {
        ...
        errorWriter.WriteLine(AnsiColor.Composite(AnsiColor.Bold, AnsiColor.Foreground(Terminal256ColorCodes.RedC9)) + string.Concat(Environment.NewLine, _programSentenceBuilder.ErrorsHeadingText()));
