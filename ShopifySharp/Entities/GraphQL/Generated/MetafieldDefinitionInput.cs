...
/// </summary>
public record MetafieldDefinitionInput : GraphQLInputObject<MetafieldDefinitionInput>
{
    /// <summary>
    /// The access settings that apply to each of the metafields that belong to the metafield definition.
    /// </summary>
    [JsonPropertyName("access")]
    public MetafieldAccessInput? access { get; set; } = null;

    /// <summary>
    /// The capabilities of the metafield definition.
    /// </summary>
    [JsonPropertyName("capabilities")]
    public MetafieldCapabilityCreateInput? capabilities { get; set; } = null;
    ...
    public MetafieldDefinitionConstraintsInput? constraints { get; set; } = null;
