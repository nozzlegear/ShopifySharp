...
/// </summary>
public record CollectionUpdateInput : GraphQLInputObject<CollectionUpdateInput>
{
    /// <summary>
    ...
    /// </summary>
    [JsonPropertyName("sourcesToCreate")]
    public ICollection<CollectionCreateSourceTargetInput>? sourcesToCreate { get; set; } = null;

    /// <summary>
    /// The IDs of the sources to delete from the collection.
    /// </summary>
    [JsonPropertyName("sourcesToDelete")]
    public ICollection<string>? sourcesToDelete { get; set; } = null;

    /// <summary>
    /// The sources to update for the collection.
    /// </summary>
    [JsonPropertyName("sourcesToUpdate")]
    public ICollection<CollectionUpdateSourceTargetInput>? sourcesToUpdate { get; set; } = null;
