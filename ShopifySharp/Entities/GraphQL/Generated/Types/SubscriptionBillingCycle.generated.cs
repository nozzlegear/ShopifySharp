...
public record SubscriptionBillingCycle : IGraphQLObject
{
    ...
    public DateTimeOffset? billingAttemptExpectedDate { get; set; } = null;
    ...
    public DateTimeOffset? cycleEndAt { get; set; } = null;
    ...
    public DateTimeOffset? cycleStartAt { get; set; } = null;
