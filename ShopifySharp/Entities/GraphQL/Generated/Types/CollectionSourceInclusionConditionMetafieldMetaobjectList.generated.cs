...
/// </summary>
public record CollectionSourceInclusionConditionMetafieldMetaobjectList : IGraphQLObject, ICollectionSourceInclusionCondition, ICollectionSourceInclusionConditionMetafield
{
    /// <summary>
    ...
    public ICollection<Metaobject>? values { get; set; } = null;
}