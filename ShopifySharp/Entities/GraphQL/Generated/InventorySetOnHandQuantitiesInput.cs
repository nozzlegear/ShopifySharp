...
/// </summary>
public record InventorySetOnHandQuantitiesInput : GraphQLInputObject<InventorySetOnHandQuantitiesInput>
{
    /// <summary>
    ...
    public ICollection<InventorySetQuantityInput>? setQuantities { get; set; } = null;
}