...
/// </summary>
public record InventorySetScheduledChangesInput : GraphQLInputObject<InventorySetScheduledChangesInput>
{
    /// <summary>
    /// The list of all the items on which the scheduled changes need to be applied.
    /// </summary>
    [JsonPropertyName("items")]
    public ICollection<InventoryScheduledChangeItemInput>? items { get; set; } = null;
