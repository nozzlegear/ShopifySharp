...
public class CollectionRuleConditionsQueryBuilder() : GraphQueryBuilder<CollectionRuleConditions>("query collectionRuleConditions")
{
    ...
    public CollectionRuleConditionsQueryBuilder AddFieldRuleObject()
    {
        AddField("ruleObject");
        return this;
    }
