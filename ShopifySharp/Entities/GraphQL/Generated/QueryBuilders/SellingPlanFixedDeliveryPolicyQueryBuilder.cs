...
public class SellingPlanFixedDeliveryPolicyQueryBuilder() : GraphQueryBuilder<SellingPlanFixedDeliveryPolicy>("query sellingPlanFixedDeliveryPolicy")
{
    public SellingPlanFixedDeliveryPolicyQueryBuilder AddFieldAnchors()
    {
        AddField("anchors");
        return this;
    }
