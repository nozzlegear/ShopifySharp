...
public class BuyerExperienceConfigurationQueryBuilder() : GraphQueryBuilder<BuyerExperienceConfiguration>("query buyerExperienceConfiguration")
{
    ...
    public BuyerExperienceConfigurationQueryBuilder AddFieldDeposit()
    {
        AddField("deposit");
        return this;
    }
    ...
    public BuyerExperienceConfigurationQueryBuilder AddFieldPaymentTermsTemplate()
    {
        AddField("paymentTermsTemplate");
        return this;
    }
