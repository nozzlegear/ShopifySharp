...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class CheckoutBrandingDesignSystemQueryBuilder : FieldsQueryBuilderBase<CheckoutBrandingDesignSystem, CheckoutBrandingDesignSystemQueryBuilder>
    {
        ...
        public CheckoutBrandingDesignSystemQueryBuilder Colors(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CheckoutBrandingColorsQueryBuilder> build)
        {
            var query = new Query<CheckoutBrandingColors>("colors");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.CheckoutBrandingColorsQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<CheckoutBrandingColors>(query);
            return this;
        }

        public CheckoutBrandingDesignSystemQueryBuilder CornerRadius(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CheckoutBrandingCornerRadiusVariablesQueryBuilder> build)
        {
            var query = new Query<CheckoutBrandingCornerRadiusVariables>("cornerRadius");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.CheckoutBrandingCornerRadiusVariablesQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<CheckoutBrandingCornerRadiusVariables>(query);
            return this;
        }

        public CheckoutBrandingDesignSystemQueryBuilder Typography(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CheckoutBrandingTypographyQueryBuilder> build)
        {
            var query = new Query<CheckoutBrandingTypography>("typography");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.CheckoutBrandingTypographyQueryBuilder(query);
            build.Invoke(queryBuilder);
