...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class DeliveryPromiseParticipantOwnerMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, DeliveryPromiseParticipantOwnerMetafieldQueryBuilder>, IHasArguments<DeliveryPromiseParticipantOwnerMetafieldArgumentsBuilder>
    {
        ...
        public DeliveryPromiseParticipantOwnerMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public DeliveryPromiseParticipantOwnerMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public DeliveryPromiseParticipantOwnerMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
