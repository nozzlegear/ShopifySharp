...
{
    public sealed class SuggestedRefundQueryBuilder : FieldsQueryBuilderBase<SuggestedRefund, SuggestedRefundQueryBuilder>, IHasArguments<SuggestedRefundArgumentsBuilder>
    {
        public SuggestedRefundArgumentsBuilder Arguments { get; }
        ...
        {
            Arguments = new SuggestedRefundArgumentsBuilder(base.InnerQuery);
        }
        ...
        public SuggestedRefundQueryBuilder SetArguments(Action<SuggestedRefundArgumentsBuilder> configure)
        {
        ...
        public SuggestedRefundQueryBuilder AmountSet(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public SuggestedRefundQueryBuilder DiscountedSubtotalSet(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public SuggestedRefundQueryBuilder MaximumRefundableSet(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public SuggestedRefundQueryBuilder RefundDuties(Action<ShopifySharp.GraphQL.QueryBuilders.Types.RefundDutyQueryBuilder> build)
        {
        ...
        public SuggestedRefundQueryBuilder RefundLineItems(Action<ShopifySharp.GraphQL.QueryBuilders.Types.RefundLineItemQueryBuilder> build)
        {
        ...
        public SuggestedRefundQueryBuilder Shipping(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ShippingRefundQueryBuilder> build)
        {
        ...
        public SuggestedRefundQueryBuilder SubtotalSet(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public SuggestedRefundQueryBuilder TotalCartDiscountAmountSet(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public SuggestedRefundQueryBuilder TotalDutiesSet(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public SuggestedRefundQueryBuilder TotalTaxSet(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
