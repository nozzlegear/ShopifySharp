...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class CompanyLocationMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, CompanyLocationMetafieldQueryBuilder>, IHasArguments<CompanyLocationMetafieldArgumentsBuilder>
    {
        ...
        public CompanyLocationMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public CompanyLocationMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public CompanyLocationMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
