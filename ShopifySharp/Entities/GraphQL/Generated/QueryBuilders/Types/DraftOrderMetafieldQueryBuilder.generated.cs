...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class DraftOrderMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, DraftOrderMetafieldQueryBuilder>, IHasArguments<DraftOrderMetafieldArgumentsBuilder>
    {
        ...
        public DraftOrderMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public DraftOrderMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public DraftOrderMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
