...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class PaymentTermsQueryBuilder : FieldsQueryBuilderBase<PaymentTerms, PaymentTermsQueryBuilder>
    {
        ...
        public PaymentTermsQueryBuilder DraftOrder(Action<ShopifySharp.GraphQL.QueryBuilders.Types.DraftOrderQueryBuilder> build)
        {
        ...
        public PaymentTermsQueryBuilder Order(Action<ShopifySharp.GraphQL.QueryBuilders.Types.OrderQueryBuilder> build)
        {
        ...
        public PaymentTermsQueryBuilder PaymentSchedules(Action<ShopifySharp.GraphQL.QueryBuilders.Types.PaymentScheduleConnectionQueryBuilder> build)
        {
            var query = new Query<PaymentScheduleConnection>("paymentSchedules");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.PaymentScheduleConnectionQueryBuilder(query);
            build.Invoke(queryBuilder);
