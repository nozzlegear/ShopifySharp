...
{
    public sealed class EventQueryBuilder : FieldsQueryBuilderBase<IEvent, EventQueryBuilder>, IHasArguments<EventArgumentsBuilder>
    {
        ...
        public EventQueryBuilder SetArguments(Action<EventArgumentsBuilder> configure)
        {
        ...
        public EventQueryBuilder OnBasicEvent(Action<ShopifySharp.GraphQL.QueryBuilders.Types.BasicEventQueryBuilder> build)
        {
        ...
        public EventQueryBuilder OnCommentEvent(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CommentEventQueryBuilder> build)
        {
        ...
        public EventQueryBuilder Event(Action<EventInterfaceCasesBuilder> build)
        {
