...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class FulfillmentOrderMerchantRequestConnectionQueryBuilder : FieldsQueryBuilderBase<FulfillmentOrderMerchantRequestConnection, FulfillmentOrderMerchantRequestConnectionQueryBuilder>
    {
        ...
        public FulfillmentOrderMerchantRequestConnectionQueryBuilder Edges(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.FulfillmentOrderMerchantRequestEdgeQueryBuilder> build)
        {
            var query = new Query<FulfillmentOrderMerchantRequestEdge>("edges");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.FulfillmentOrderMerchantRequestEdgeQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<FulfillmentOrderMerchantRequestEdge>(query);
            return this;
        }

        public FulfillmentOrderMerchantRequestConnectionQueryBuilder Nodes(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.FulfillmentOrderMerchantRequestQueryBuilder> build)
        {
        ...
        public FulfillmentOrderMerchantRequestConnectionQueryBuilder PageInfo(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.PageInfoQueryBuilder> build)
        {
