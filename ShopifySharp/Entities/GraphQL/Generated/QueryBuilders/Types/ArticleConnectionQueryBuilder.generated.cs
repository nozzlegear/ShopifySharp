...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class ArticleConnectionQueryBuilder : FieldsQueryBuilderBase<ArticleConnection, ArticleConnectionQueryBuilder>
    {
        ...
        public ArticleConnectionQueryBuilder Edges(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.ArticleEdgeQueryBuilder> build)
        {
            var query = new Query<ArticleEdge>("edges");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.ArticleEdgeQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<ArticleEdge>(query);
            return this;
        }

        public ArticleConnectionQueryBuilder Nodes(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.ArticleQueryBuilder> build)
        {
        ...
        public ArticleConnectionQueryBuilder PageInfo(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.PageInfoQueryBuilder> build)
        {
