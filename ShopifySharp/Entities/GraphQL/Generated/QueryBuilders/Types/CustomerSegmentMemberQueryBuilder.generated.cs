...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class CustomerSegmentMemberQueryBuilder : FieldsQueryBuilderBase<CustomerSegmentMember, CustomerSegmentMemberQueryBuilder>
    {
        ...
        public CustomerSegmentMemberQueryBuilder AmountSpent(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyV2QueryBuilder> build)
        {
        ...
        public CustomerSegmentMemberQueryBuilder DefaultAddress(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MailingAddressQueryBuilder> build)
        {
        ...
        public CustomerSegmentMemberQueryBuilder DefaultEmailAddress(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CustomerEmailAddressQueryBuilder> build)
        {
        ...
        public CustomerSegmentMemberQueryBuilder DefaultPhoneNumber(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CustomerPhoneNumberQueryBuilder> build)
        {
        ...
        public CustomerSegmentMemberQueryBuilder Mergeable(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CustomerMergeableQueryBuilder> build)
        {
        ...
        public CustomerSegmentMemberQueryBuilder Metafield(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldQueryBuilder> build)
        {
        ...
        public CustomerSegmentMemberQueryBuilder Metafields(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldConnectionQueryBuilder> build)
        {
