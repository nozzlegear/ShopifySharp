...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class ShopPayPaymentRequestLineItemQueryBuilder : FieldsQueryBuilderBase<ShopPayPaymentRequestLineItem, ShopPayPaymentRequestLineItemQueryBuilder>
    {
        ...
        public ShopPayPaymentRequestLineItemQueryBuilder FinalItemPrice(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyV2QueryBuilder> build)
        {
        ...
        public ShopPayPaymentRequestLineItemQueryBuilder FinalLinePrice(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyV2QueryBuilder> build)
        {
        ...
        public ShopPayPaymentRequestLineItemQueryBuilder Image(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ShopPayPaymentRequestImageQueryBuilder> build)
        {
            var query = new Query<ShopPayPaymentRequestImage>("image");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.ShopPayPaymentRequestImageQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<ShopPayPaymentRequestImage>(query);
            return this;
        }

        public ShopPayPaymentRequestLineItemQueryBuilder ItemDiscounts(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ShopPayPaymentRequestDiscountQueryBuilder> build)
        {
        ...
        public ShopPayPaymentRequestLineItemQueryBuilder LineDiscounts(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ShopPayPaymentRequestDiscountQueryBuilder> build)
        {
        ...
        public ShopPayPaymentRequestLineItemQueryBuilder OriginalItemPrice(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyV2QueryBuilder> build)
        {
        ...
        public ShopPayPaymentRequestLineItemQueryBuilder OriginalLinePrice(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyV2QueryBuilder> build)
        {
