...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class BlogMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, BlogMetafieldQueryBuilder>, IHasArguments<BlogMetafieldArgumentsBuilder>
    {
        ...
        public BlogMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public BlogMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public BlogMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
