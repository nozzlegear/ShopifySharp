...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class CheckoutAndAccountsConfigurationBrandingImageValueUnionCasesBuilder : UnionCasesBuilderBase<CheckoutAndAccountsConfigurationBrandingImageValue, CheckoutAndAccountsConfigurationBrandingImageValueUnionCasesBuilder>
    {
        ...
        public CheckoutAndAccountsConfigurationBrandingImageValueUnionCasesBuilder OnCheckoutAndAccountsConfigurationBrandingImage(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CheckoutAndAccountsConfigurationBrandingImageQueryBuilder> build)
        {
            var query = new Query<CheckoutAndAccountsConfigurationBrandingImage>("... on CheckoutAndAccountsConfigurationBrandingImage");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.CheckoutAndAccountsConfigurationBrandingImageQueryBuilder(query);
