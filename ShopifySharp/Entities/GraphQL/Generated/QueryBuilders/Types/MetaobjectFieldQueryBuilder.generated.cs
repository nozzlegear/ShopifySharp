...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class MetaobjectFieldQueryBuilder : FieldsQueryBuilderBase<MetaobjectField, MetaobjectFieldQueryBuilder>
    {
        ...
        public MetaobjectFieldQueryBuilder Definition(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.MetaobjectFieldDefinitionQueryBuilder> build)
        {
        ...
        public MetaobjectFieldQueryBuilder References(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.MetafieldReferenceConnectionQueryBuilder> build)
        {
        ...
        public MetaobjectFieldQueryBuilder Thumbnail(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.MetaobjectThumbnailQueryBuilder> build)
        {
            var query = new Query<MetaobjectThumbnail>("thumbnail");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.MetaobjectThumbnailQueryBuilder(query);
            build.Invoke(queryBuilder);
