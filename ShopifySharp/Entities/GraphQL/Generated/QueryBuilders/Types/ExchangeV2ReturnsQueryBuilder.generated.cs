...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class ExchangeV2ReturnsQueryBuilder : FieldsQueryBuilderBase<ExchangeV2Returns, ExchangeV2ReturnsQueryBuilder>
    {
        ...
        public ExchangeV2ReturnsQueryBuilder LineItems(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ExchangeV2LineItemQueryBuilder> build)
        {
        ...
        public ExchangeV2ReturnsQueryBuilder OrderDiscountAmountSet(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public ExchangeV2ReturnsQueryBuilder ShippingRefundAmountSet(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public ExchangeV2ReturnsQueryBuilder SubtotalPriceSet(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public ExchangeV2ReturnsQueryBuilder TaxLines(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TaxLineQueryBuilder> build)
        {
        ...
        public ExchangeV2ReturnsQueryBuilder TipRefundAmountSet(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public ExchangeV2ReturnsQueryBuilder TotalPriceSet(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
