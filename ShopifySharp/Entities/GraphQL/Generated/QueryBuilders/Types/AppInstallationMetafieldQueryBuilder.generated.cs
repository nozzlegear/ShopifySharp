...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class AppInstallationMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, AppInstallationMetafieldQueryBuilder>, IHasArguments<AppInstallationMetafieldArgumentsBuilder>
    {
        ...
        public AppInstallationMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public AppInstallationMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public AppInstallationMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
