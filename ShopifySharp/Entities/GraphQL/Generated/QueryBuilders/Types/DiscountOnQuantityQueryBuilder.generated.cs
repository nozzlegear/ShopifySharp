...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class DiscountOnQuantityQueryBuilder : FieldsQueryBuilderBase<DiscountOnQuantity, DiscountOnQuantityQueryBuilder>
    {
        ...
        public DiscountOnQuantityQueryBuilder Quantity(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.DiscountQuantityQueryBuilder> build)
        {
            var query = new Query<DiscountQuantity>("quantity");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.DiscountQuantityQueryBuilder(query);
