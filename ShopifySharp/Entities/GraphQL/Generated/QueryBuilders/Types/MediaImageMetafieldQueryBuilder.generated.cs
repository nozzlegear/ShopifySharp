...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class MediaImageMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, MediaImageMetafieldQueryBuilder>, IHasArguments<MediaImageMetafieldArgumentsBuilder>
    {
        ...
        public MediaImageMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public MediaImageMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public MediaImageMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
