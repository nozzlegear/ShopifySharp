...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class ShopifyPaymentsPayoutQueryBuilder : FieldsQueryBuilderBase<ShopifyPaymentsPayout, ShopifyPaymentsPayoutQueryBuilder>
    {
        ...
        public ShopifyPaymentsPayoutQueryBuilder BankAccount(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ShopifyPaymentsBankAccountQueryBuilder> build)
        {
        ...
        public ShopifyPaymentsPayoutQueryBuilder BusinessEntity(Action<ShopifySharp.GraphQL.QueryBuilders.Types.BusinessEntityQueryBuilder> build)
        {
        ...
        public ShopifyPaymentsPayoutQueryBuilder Net(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyV2QueryBuilder> build)
        {
        ...
        public ShopifyPaymentsPayoutQueryBuilder Summary(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ShopifyPaymentsPayoutSummaryQueryBuilder> build)
        {
            var query = new Query<ShopifyPaymentsPayoutSummary>("summary");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.ShopifyPaymentsPayoutSummaryQueryBuilder(query);
            build.Invoke(queryBuilder);
