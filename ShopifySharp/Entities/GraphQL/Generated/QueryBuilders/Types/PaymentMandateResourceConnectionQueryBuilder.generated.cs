...
{
    public sealed class PaymentMandateResourceConnectionQueryBuilder : FieldsQueryBuilderBase<PaymentMandateResourceConnection, PaymentMandateResourceConnectionQueryBuilder>, IHasArguments<PaymentMandateResourceConnectionArgumentsBuilder>
    {
        public PaymentMandateResourceConnectionArgumentsBuilder Arguments { get; }
        ...
        {
            Arguments = new PaymentMandateResourceConnectionArgumentsBuilder(base.InnerQuery);
        }
        ...
        public PaymentMandateResourceConnectionQueryBuilder SetArguments(Action<PaymentMandateResourceConnectionArgumentsBuilder> configure)
        {
