...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class MarketMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, MarketMetafieldQueryBuilder>, IHasArguments<MarketMetafieldArgumentsBuilder>
    {
        ...
        public MarketMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public MarketMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public MarketMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
