...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class AppSubscriptionLineItemQueryBuilder : FieldsQueryBuilderBase<AppSubscriptionLineItem, AppSubscriptionLineItemQueryBuilder>
    {
        ...
        public AppSubscriptionLineItemQueryBuilder Plan(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.AppPlanV2QueryBuilder> build)
        {
            var query = new Query<AppPlanV2>("plan");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.AppPlanV2QueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<AppPlanV2>(query);
            return this;
        }

        public AppSubscriptionLineItemQueryBuilder UsageRecords(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.AppUsageRecordConnectionQueryBuilder> build)
        {
            var query = new Query<AppUsageRecordConnection>("usageRecords");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.AppUsageRecordConnectionQueryBuilder(query);
            build.Invoke(queryBuilder);
