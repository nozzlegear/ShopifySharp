...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class SellingPlanQueryBuilder : FieldsQueryBuilderBase<SellingPlan, SellingPlanQueryBuilder>
    {
        ...
        public SellingPlanQueryBuilder InventoryPolicy(Action<ShopifySharp.GraphQL.QueryBuilders.Types.SellingPlanInventoryPolicyQueryBuilder> build)
        {
            var query = new Query<SellingPlanInventoryPolicy>("inventoryPolicy");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.SellingPlanInventoryPolicyQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<SellingPlanInventoryPolicy>(query);
            return this;
        }

        public SellingPlanQueryBuilder Metafield(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldQueryBuilder> build)
        {
        ...
        public SellingPlanQueryBuilder MetafieldDefinitions(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldDefinitionConnectionQueryBuilder> build)
        {
        ...
        public SellingPlanQueryBuilder Metafields(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldConnectionQueryBuilder> build)
        {
        ...
        public SellingPlanQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
