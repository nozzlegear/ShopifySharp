...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class ShopMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, ShopMetafieldQueryBuilder>, IHasArguments<ShopMetafieldArgumentsBuilder>
    {
        ...
        public ShopMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public ShopMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public ShopMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
