...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class ImageMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, ImageMetafieldQueryBuilder>, IHasArguments<ImageMetafieldArgumentsBuilder>
    {
        ...
        public ImageMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public ImageMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public ImageMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
