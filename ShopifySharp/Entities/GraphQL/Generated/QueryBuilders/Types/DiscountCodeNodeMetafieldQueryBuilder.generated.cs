...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class DiscountCodeNodeMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, DiscountCodeNodeMetafieldQueryBuilder>, IHasArguments<DiscountCodeNodeMetafieldArgumentsBuilder>
    {
        ...
        public DiscountCodeNodeMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public DiscountCodeNodeMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public DiscountCodeNodeMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
