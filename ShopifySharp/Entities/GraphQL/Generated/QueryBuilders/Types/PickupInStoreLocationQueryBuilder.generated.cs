...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class PickupInStoreLocationQueryBuilder : FieldsQueryBuilderBase<PickupInStoreLocation, PickupInStoreLocationQueryBuilder>
    {
        ...
        public PickupInStoreLocationQueryBuilder DistanceFromBuyer(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.DistanceQueryBuilder> build)
        {
            var query = new Query<Distance>("distanceFromBuyer");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.DistanceQueryBuilder(query);
