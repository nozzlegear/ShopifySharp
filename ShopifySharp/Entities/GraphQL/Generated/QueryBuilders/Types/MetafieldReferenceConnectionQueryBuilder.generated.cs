...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class MetafieldReferenceConnectionQueryBuilder : FieldsQueryBuilderBase<MetafieldReferenceConnection, MetafieldReferenceConnectionQueryBuilder>
    {
        ...
        public MetafieldReferenceConnectionQueryBuilder Edges(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.MetafieldReferenceEdgeQueryBuilder> build)
        {
            var query = new Query<MetafieldReferenceEdge>("edges");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.MetafieldReferenceEdgeQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<MetafieldReferenceEdge>(query);
            return this;
        }

        public MetafieldReferenceConnectionQueryBuilder PageInfo(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.PageInfoQueryBuilder> build)
        {
