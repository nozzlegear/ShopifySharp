...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class MetafieldReferenceMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, MetafieldReferenceMetafieldQueryBuilder>, IHasArguments<MetafieldReferenceMetafieldArgumentsBuilder>
    {
        ...
        public MetafieldReferenceMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public MetafieldReferenceMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public MetafieldReferenceMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
