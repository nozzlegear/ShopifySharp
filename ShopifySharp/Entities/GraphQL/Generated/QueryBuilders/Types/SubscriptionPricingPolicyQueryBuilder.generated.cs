...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class SubscriptionPricingPolicyQueryBuilder : FieldsQueryBuilderBase<SubscriptionPricingPolicy, SubscriptionPricingPolicyQueryBuilder>
    {
        ...
        public SubscriptionPricingPolicyQueryBuilder BasePrice(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.MoneyV2QueryBuilder> build)
        {
        ...
        public SubscriptionPricingPolicyQueryBuilder CycleDiscounts(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.SubscriptionCyclePriceAdjustmentQueryBuilder> build)
        {
            var query = new Query<SubscriptionCyclePriceAdjustment>("cycleDiscounts");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.SubscriptionCyclePriceAdjustmentQueryBuilder(query);
            build.Invoke(queryBuilder);
