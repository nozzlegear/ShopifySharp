...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class CommentEventQueryBuilder : FieldsQueryBuilderBase<CommentEvent, CommentEventQueryBuilder>
    {
        ...
        public CommentEventQueryBuilder Attachments(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CommentEventAttachmentQueryBuilder> build)
        {
            var query = new Query<CommentEventAttachment>("attachments");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.CommentEventAttachmentQueryBuilder(query);
        ...
        public CommentEventQueryBuilder Author(Action<ShopifySharp.GraphQL.QueryBuilders.Types.StaffMemberQueryBuilder> build)
        {
        ...
        public CommentEventQueryBuilder Subject(Action<CommentEventSubjectInterfaceCasesBuilder> build)
        {
