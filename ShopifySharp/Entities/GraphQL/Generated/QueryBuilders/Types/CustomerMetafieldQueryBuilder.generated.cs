...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class CustomerMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, CustomerMetafieldQueryBuilder>, IHasArguments<CustomerMetafieldArgumentsBuilder>
    {
        ...
        public CustomerMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public CustomerMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public CustomerMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
