...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class MarketConditionsQueryBuilder : FieldsQueryBuilderBase<MarketConditions, MarketConditionsQueryBuilder>
    {
        ...
        public MarketConditionsQueryBuilder CompanyLocationsCondition(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.CompanyLocationsConditionQueryBuilder> build)
        {
            var query = new Query<CompanyLocationsCondition>("companyLocationsCondition");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.CompanyLocationsConditionQueryBuilder(query);
        ...
        public MarketConditionsQueryBuilder LocationsCondition(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.LocationsConditionQueryBuilder> build)
        {
            var query = new Query<LocationsCondition>("locationsCondition");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.LocationsConditionQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<LocationsCondition>(query);
            return this;
        }

        public MarketConditionsQueryBuilder RegionsCondition(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.RegionsConditionQueryBuilder> build)
        {
            var query = new Query<RegionsCondition>("regionsCondition");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.RegionsConditionQueryBuilder(query);
            build.Invoke(queryBuilder);
