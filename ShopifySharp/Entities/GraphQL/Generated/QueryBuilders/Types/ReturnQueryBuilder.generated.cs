...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class ReturnQueryBuilder : FieldsQueryBuilderBase<Return, ReturnQueryBuilder>
    {
        ...
        public ReturnQueryBuilder Decline(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ReturnDeclineQueryBuilder> build)
        {
        ...
        public ReturnQueryBuilder ExchangeLineItems(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ExchangeLineItemConnectionQueryBuilder> build)
        {
        ...
        public ReturnQueryBuilder Order(Action<ShopifySharp.GraphQL.QueryBuilders.Types.OrderQueryBuilder> build)
        {
        ...
        public ReturnQueryBuilder Refunds(Action<ShopifySharp.GraphQL.QueryBuilders.Types.RefundConnectionQueryBuilder> build)
        {
        ...
        public ReturnQueryBuilder ReturnLineItems(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ReturnLineItemTypeConnectionQueryBuilder> build)
        {
        ...
        public ReturnQueryBuilder ReturnShippingFees(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ReturnShippingFeeQueryBuilder> build)
        {
        ...
        public ReturnQueryBuilder ReverseFulfillmentOrders(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ReverseFulfillmentOrderConnectionQueryBuilder> build)
        {
        ...
        public ReturnQueryBuilder SuggestedFinancialOutcome(Action<ShopifySharp.GraphQL.QueryBuilders.Types.SuggestedReturnFinancialOutcomeQueryBuilder> build)
        {
        ...
        public ReturnQueryBuilder SuggestedRefund(Action<ShopifySharp.GraphQL.QueryBuilders.Types.SuggestedReturnRefundQueryBuilder> build)
        {
