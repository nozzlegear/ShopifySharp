...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class PurchasingEntityMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, PurchasingEntityMetafieldQueryBuilder>, IHasArguments<PurchasingEntityMetafieldArgumentsBuilder>
    {
        ...
        public PurchasingEntityMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public PurchasingEntityMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public PurchasingEntityMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
