...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class DeliveryProfileQueryBuilder : FieldsQueryBuilderBase<DeliveryProfile, DeliveryProfileQueryBuilder>
    {
        ...
        public DeliveryProfileQueryBuilder ProductVariantsCount(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CountQueryBuilder> build)
        {
        ...
        public DeliveryProfileQueryBuilder ProductVariantsCountV2(Action<ShopifySharp.GraphQL.QueryBuilders.Types.DeliveryProductVariantsCountQueryBuilder> build)
        {
        ...
        public DeliveryProfileQueryBuilder ProfileItems(Action<ShopifySharp.GraphQL.QueryBuilders.Types.DeliveryProfileItemConnectionQueryBuilder> build)
        {
        ...
        public DeliveryProfileQueryBuilder ProfileLocationGroups(Action<ShopifySharp.GraphQL.QueryBuilders.Types.DeliveryProfileLocationGroupQueryBuilder> build)
        {
        ...
        public DeliveryProfileQueryBuilder SellingPlanGroups(Action<ShopifySharp.GraphQL.QueryBuilders.Types.SellingPlanGroupConnectionQueryBuilder> build)
        {
        ...
        public DeliveryProfileQueryBuilder UnassignedLocations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.LocationQueryBuilder> build)
        {
        ...
        public DeliveryProfileQueryBuilder UnassignedLocationsPaginated(Action<ShopifySharp.GraphQL.QueryBuilders.Types.LocationConnectionQueryBuilder> build)
        {
