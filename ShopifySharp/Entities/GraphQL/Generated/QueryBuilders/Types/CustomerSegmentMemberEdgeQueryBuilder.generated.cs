...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class CustomerSegmentMemberEdgeQueryBuilder : FieldsQueryBuilderBase<CustomerSegmentMemberEdge, CustomerSegmentMemberEdgeQueryBuilder>
    {
        ...
        public CustomerSegmentMemberEdgeQueryBuilder Node(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.CustomerSegmentMemberQueryBuilder> build)
        {
            var query = new Query<CustomerSegmentMember>("node");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.CustomerSegmentMemberQueryBuilder(query);
