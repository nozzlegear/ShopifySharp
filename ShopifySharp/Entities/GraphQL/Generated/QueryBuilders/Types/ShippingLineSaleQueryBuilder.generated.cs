...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class ShippingLineSaleQueryBuilder : FieldsQueryBuilderBase<ShippingLineSale, ShippingLineSaleQueryBuilder>
    {
        ...
        public ShippingLineSaleQueryBuilder ShippingLine(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ShippingLineQueryBuilder> build)
        {
        ...
        public ShippingLineSaleQueryBuilder Taxes(Action<ShopifySharp.GraphQL.QueryBuilders.Types.SaleTaxQueryBuilder> build)
        {
        ...
        public ShippingLineSaleQueryBuilder TotalAmount(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public ShippingLineSaleQueryBuilder TotalDiscountAmountAfterTaxes(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public ShippingLineSaleQueryBuilder TotalDiscountAmountBeforeTaxes(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public ShippingLineSaleQueryBuilder TotalTaxAmount(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
