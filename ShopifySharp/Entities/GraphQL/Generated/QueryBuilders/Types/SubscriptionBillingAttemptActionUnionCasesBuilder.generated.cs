...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class SubscriptionBillingAttemptActionUnionCasesBuilder : UnionCasesBuilderBase<SubscriptionBillingAttemptAction, SubscriptionBillingAttemptActionUnionCasesBuilder>
    {
        ...
        public SubscriptionBillingAttemptActionUnionCasesBuilder OnSubscriptionBillingAttemptPaymentChallenge(Action<ShopifySharp.GraphQL.QueryBuilders.Types.SubscriptionBillingAttemptPaymentChallengeQueryBuilder> build)
        {
            var query = new Query<SubscriptionBillingAttemptPaymentChallenge>("... on SubscriptionBillingAttemptPaymentChallenge");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.SubscriptionBillingAttemptPaymentChallengeQueryBuilder(query);
