...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class PageMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, PageMetafieldQueryBuilder>, IHasArguments<PageMetafieldArgumentsBuilder>
    {
        ...
        public PageMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public PageMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public PageMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
