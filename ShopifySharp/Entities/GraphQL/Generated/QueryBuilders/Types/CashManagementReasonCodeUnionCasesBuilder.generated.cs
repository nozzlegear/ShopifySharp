...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class CashManagementReasonCodeUnionCasesBuilder : UnionCasesBuilderBase<CashManagementReasonCode, CashManagementReasonCodeUnionCasesBuilder>
    {
        ...
        public CashManagementReasonCodeUnionCasesBuilder(string fieldName = "node") : this(new Query<CashManagementReasonCode>(fieldName))
        {
        }
        ...
        public CashManagementReasonCodeUnionCasesBuilder OnCashManagementCustomReasonCode(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CashManagementCustomReasonCodeQueryBuilder> build)
        {
        ...
        public CashManagementReasonCodeUnionCasesBuilder OnCashManagementDefaultReasonCode(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CashManagementDefaultReasonCodeQueryBuilder> build)
        {
        ...
        public CashManagementReasonCodeUnionCasesBuilder OnCashManagementSystemReasonCode(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CashManagementSystemReasonCodeQueryBuilder> build)
        {
