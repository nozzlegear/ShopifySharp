...
{
    public sealed class BulkOperationConnectionQueryBuilder : FieldsQueryBuilderBase<BulkOperationConnection, BulkOperationConnectionQueryBuilder>, IHasArguments<BulkOperationConnectionArgumentsBuilder>
    {
        public BulkOperationConnectionArgumentsBuilder Arguments { get; }
        ...
        {
            Arguments = new BulkOperationConnectionArgumentsBuilder(base.InnerQuery);
        }
        ...
        public BulkOperationConnectionQueryBuilder SetArguments(Action<BulkOperationConnectionArgumentsBuilder> configure)
        {
