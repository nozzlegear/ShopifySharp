...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class QuantityPriceBreakConnectionQueryBuilder : FieldsQueryBuilderBase<QuantityPriceBreakConnection, QuantityPriceBreakConnectionQueryBuilder>
    {
        ...
        public QuantityPriceBreakConnectionQueryBuilder Edges(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.QuantityPriceBreakEdgeQueryBuilder> build)
        {
            var query = new Query<QuantityPriceBreakEdge>("edges");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.QuantityPriceBreakEdgeQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<QuantityPriceBreakEdge>(query);
            return this;
        }

        public QuantityPriceBreakConnectionQueryBuilder Nodes(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.QuantityPriceBreakQueryBuilder> build)
        {
        ...
        public QuantityPriceBreakConnectionQueryBuilder PageInfo(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.PageInfoQueryBuilder> build)
        {
