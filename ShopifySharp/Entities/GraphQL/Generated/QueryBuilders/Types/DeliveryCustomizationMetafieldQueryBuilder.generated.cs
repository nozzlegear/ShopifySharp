...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class DeliveryCustomizationMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, DeliveryCustomizationMetafieldQueryBuilder>, IHasArguments<DeliveryCustomizationMetafieldArgumentsBuilder>
    {
        ...
        public DeliveryCustomizationMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public DeliveryCustomizationMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public DeliveryCustomizationMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
