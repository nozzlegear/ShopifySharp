...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class DeliveryMethodQueryBuilder : FieldsQueryBuilderBase<DeliveryMethod, DeliveryMethodQueryBuilder>
    {
        ...
        public DeliveryMethodQueryBuilder AdditionalInformation(Action<ShopifySharp.GraphQL.QueryBuilders.Types.DeliveryMethodAdditionalInformationQueryBuilder> build)
        {
            var query = new Query<DeliveryMethodAdditionalInformation>("additionalInformation");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.DeliveryMethodAdditionalInformationQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<DeliveryMethodAdditionalInformation>(query);
            return this;
        }

        public DeliveryMethodQueryBuilder BrandedPromise(Action<ShopifySharp.GraphQL.QueryBuilders.Types.DeliveryBrandedPromiseQueryBuilder> build)
        {
            var query = new Query<DeliveryBrandedPromise>("brandedPromise");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.DeliveryBrandedPromiseQueryBuilder(query);
            build.Invoke(queryBuilder);
