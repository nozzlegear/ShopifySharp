...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class TaxonomyCategoryQueryBuilder : FieldsQueryBuilderBase<TaxonomyCategory, TaxonomyCategoryQueryBuilder>
    {
        ...
        public TaxonomyCategoryQueryBuilder Attributes(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TaxonomyCategoryAttributeConnectionQueryBuilder> build)
        {
            var query = new Query<TaxonomyCategoryAttributeConnection>("attributes");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.TaxonomyCategoryAttributeConnectionQueryBuilder(query);
