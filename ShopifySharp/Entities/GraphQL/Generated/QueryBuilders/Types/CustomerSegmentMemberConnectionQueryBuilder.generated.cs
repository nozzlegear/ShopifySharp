...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class CustomerSegmentMemberConnectionQueryBuilder : FieldsQueryBuilderBase<CustomerSegmentMemberConnection, CustomerSegmentMemberConnectionQueryBuilder>
    {
        ...
        public CustomerSegmentMemberConnectionQueryBuilder Edges(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.CustomerSegmentMemberEdgeQueryBuilder> build)
        {
            var query = new Query<CustomerSegmentMemberEdge>("edges");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.CustomerSegmentMemberEdgeQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<CustomerSegmentMemberEdge>(query);
            return this;
        }

        public CustomerSegmentMemberConnectionQueryBuilder PageInfo(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.PageInfoQueryBuilder> build)
        {
        ...
        public CustomerSegmentMemberConnectionQueryBuilder Statistics(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.SegmentStatisticsQueryBuilder> build)
        {
            var query = new Query<SegmentStatistics>("statistics");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.SegmentStatisticsQueryBuilder(query);
            build.Invoke(queryBuilder);
