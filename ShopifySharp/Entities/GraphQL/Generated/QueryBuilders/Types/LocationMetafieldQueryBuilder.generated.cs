...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class LocationMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, LocationMetafieldQueryBuilder>, IHasArguments<LocationMetafieldArgumentsBuilder>
    {
        ...
        public LocationMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public LocationMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public LocationMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
