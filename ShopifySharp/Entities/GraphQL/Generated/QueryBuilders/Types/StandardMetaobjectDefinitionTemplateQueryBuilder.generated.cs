...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class StandardMetaobjectDefinitionTemplateQueryBuilder : FieldsQueryBuilderBase<StandardMetaobjectDefinitionTemplate, StandardMetaobjectDefinitionTemplateQueryBuilder>
    {
        ...
        public StandardMetaobjectDefinitionTemplateQueryBuilder EnabledCapabilities(Action<ShopifySharp.GraphQL.QueryBuilders.Types.StandardMetaobjectCapabilityTemplateQueryBuilder> build)
        {
            var query = new Query<StandardMetaobjectCapabilityTemplate>("enabledCapabilities");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.StandardMetaobjectCapabilityTemplateQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<StandardMetaobjectCapabilityTemplate>(query);
            return this;
        }

        public StandardMetaobjectDefinitionTemplateQueryBuilder FieldDefinitions(Action<ShopifySharp.GraphQL.QueryBuilders.Types.StandardMetaobjectDefinitionFieldTemplateQueryBuilder> build)
        {
            var query = new Query<StandardMetaobjectDefinitionFieldTemplate>("fieldDefinitions");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.StandardMetaobjectDefinitionFieldTemplateQueryBuilder(query);
            build.Invoke(queryBuilder);
