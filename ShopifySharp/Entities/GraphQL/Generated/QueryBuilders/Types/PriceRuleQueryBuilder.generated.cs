...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class PriceRuleQueryBuilder : FieldsQueryBuilderBase<PriceRule, PriceRuleQueryBuilder>
    {
        ...
        public PriceRuleQueryBuilder App(Action<ShopifySharp.GraphQL.QueryBuilders.Types.AppQueryBuilder> build)
        {
        ...
        public PriceRuleQueryBuilder CombinesWith(Action<ShopifySharp.GraphQL.QueryBuilders.Types.DiscountCombinesWithQueryBuilder> build)
        {
        ...
        public PriceRuleQueryBuilder CustomerSelection(Action<ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleCustomerSelectionQueryBuilder> build)
        {
            var query = new Query<PriceRuleCustomerSelection>("customerSelection");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleCustomerSelectionQueryBuilder(query);
            build.Invoke(queryBuilder);
        ...
        public PriceRuleQueryBuilder DiscountCodes(Action<ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleDiscountCodeConnectionQueryBuilder> build)
        {
            var query = new Query<PriceRuleDiscountCodeConnection>("discountCodes");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleDiscountCodeConnectionQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<PriceRuleDiscountCodeConnection>(query);
            return this;
        }

        public PriceRuleQueryBuilder DiscountCodesCount(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CountQueryBuilder> build)
        {
        ...
        public PriceRuleQueryBuilder EntitlementToPrerequisiteQuantityRatio(Action<ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleEntitlementToPrerequisiteQuantityRatioQueryBuilder> build)
        {
            var query = new Query<PriceRuleEntitlementToPrerequisiteQuantityRatio>("entitlementToPrerequisiteQuantityRatio");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleEntitlementToPrerequisiteQuantityRatioQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<PriceRuleEntitlementToPrerequisiteQuantityRatio>(query);
            return this;
        }

        public PriceRuleQueryBuilder Events(Action<ShopifySharp.GraphQL.QueryBuilders.Types.EventConnectionQueryBuilder> build)
        {
        ...
        public PriceRuleQueryBuilder ItemEntitlements(Action<ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleItemEntitlementsQueryBuilder> build)
        {
            var query = new Query<PriceRuleItemEntitlements>("itemEntitlements");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleItemEntitlementsQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<PriceRuleItemEntitlements>(query);
            return this;
        }

        public PriceRuleQueryBuilder ItemPrerequisites(Action<ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleLineItemPrerequisitesQueryBuilder> build)
        {
            var query = new Query<PriceRuleLineItemPrerequisites>("itemPrerequisites");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleLineItemPrerequisitesQueryBuilder(query);
            build.Invoke(queryBuilder);
        ...
        public PriceRuleQueryBuilder PrerequisiteQuantityRange(Action<ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleQuantityRangeQueryBuilder> build)
        {
            var query = new Query<PriceRuleQuantityRange>("prerequisiteQuantityRange");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleQuantityRangeQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<PriceRuleQuantityRange>(query);
            return this;
        }

        public PriceRuleQueryBuilder PrerequisiteShippingPriceRange(Action<ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleMoneyRangeQueryBuilder> build)
        {
            var query = new Query<PriceRuleMoneyRange>("prerequisiteShippingPriceRange");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleMoneyRangeQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<PriceRuleMoneyRange>(query);
            return this;
        }

        public PriceRuleQueryBuilder PrerequisiteSubtotalRange(Action<ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleMoneyRangeQueryBuilder> build)
        {
        ...
        public PriceRuleQueryBuilder PrerequisiteToEntitlementQuantityRatio(Action<ShopifySharp.GraphQL.QueryBuilders.Types.PriceRulePrerequisiteToEntitlementQuantityRatioQueryBuilder> build)
        {
            var query = new Query<PriceRulePrerequisiteToEntitlementQuantityRatio>("prerequisiteToEntitlementQuantityRatio");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.PriceRulePrerequisiteToEntitlementQuantityRatioQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<PriceRulePrerequisiteToEntitlementQuantityRatio>(query);
            return this;
        }

        public PriceRuleQueryBuilder ShareableUrls(Action<ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleShareableUrlQueryBuilder> build)
        {
            var query = new Query<PriceRuleShareableUrl>("shareableUrls");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleShareableUrlQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<PriceRuleShareableUrl>(query);
            return this;
        }

        public PriceRuleQueryBuilder ShippingEntitlements(Action<ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleShippingLineEntitlementsQueryBuilder> build)
        {
            var query = new Query<PriceRuleShippingLineEntitlements>("shippingEntitlements");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleShippingLineEntitlementsQueryBuilder(query);
            build.Invoke(queryBuilder);
        ...
        public PriceRuleQueryBuilder TotalSales(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyV2QueryBuilder> build)
        {
        ...
        public PriceRuleQueryBuilder ValidityPeriod(Action<ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleValidityPeriodQueryBuilder> build)
        {
            var query = new Query<PriceRuleValidityPeriod>("validityPeriod");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.PriceRuleValidityPeriodQueryBuilder(query);
            build.Invoke(queryBuilder);
