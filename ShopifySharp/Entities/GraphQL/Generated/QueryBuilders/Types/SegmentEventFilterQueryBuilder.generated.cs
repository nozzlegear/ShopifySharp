...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class SegmentEventFilterQueryBuilder : FieldsQueryBuilderBase<SegmentEventFilter, SegmentEventFilterQueryBuilder>
    {
        ...
        public SegmentEventFilterQueryBuilder Parameters(Action<ShopifySharp.GraphQL.QueryBuilders.Types.SegmentEventFilterParameterQueryBuilder> build)
        {
            var query = new Query<SegmentEventFilterParameter>("parameters");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.SegmentEventFilterParameterQueryBuilder(query);
