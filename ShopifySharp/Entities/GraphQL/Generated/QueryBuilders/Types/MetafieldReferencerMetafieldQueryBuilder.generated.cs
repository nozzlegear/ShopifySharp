...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class MetafieldReferencerMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, MetafieldReferencerMetafieldQueryBuilder>, IHasArguments<MetafieldReferencerMetafieldArgumentsBuilder>
    {
        ...
        public MetafieldReferencerMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public MetafieldReferencerMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public MetafieldReferencerMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
