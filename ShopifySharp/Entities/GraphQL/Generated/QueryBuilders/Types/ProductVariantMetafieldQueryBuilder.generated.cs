...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class ProductVariantMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, ProductVariantMetafieldQueryBuilder>, IHasArguments<ProductVariantMetafieldArgumentsBuilder>
    {
        ...
        public ProductVariantMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public ProductVariantMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public ProductVariantMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
