...
{
    public sealed class CustomerQueryBuilder : FieldsQueryBuilderBase<Customer, CustomerQueryBuilder>, IHasArguments<CustomerArgumentsBuilder>
    {
        ...
        public CustomerQueryBuilder SetArguments(Action<CustomerArgumentsBuilder> configure)
        {
        ...
        public CustomerQueryBuilder IdentityProviderSubjects(Action<ShopifySharp.GraphQL.QueryBuilders.Types.IdentityProviderSubjectQueryBuilder> build)
        {
        ...
        public CustomerQueryBuilder TaxSettings(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TaxSettingsQueryBuilder> build)
        {
