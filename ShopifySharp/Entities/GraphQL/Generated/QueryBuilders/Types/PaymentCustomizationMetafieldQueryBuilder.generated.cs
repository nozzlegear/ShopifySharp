...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class PaymentCustomizationMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, PaymentCustomizationMetafieldQueryBuilder>, IHasArguments<PaymentCustomizationMetafieldArgumentsBuilder>
    {
        ...
        public PaymentCustomizationMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public PaymentCustomizationMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public PaymentCustomizationMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
