...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class CartTransformMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, CartTransformMetafieldQueryBuilder>, IHasArguments<CartTransformMetafieldArgumentsBuilder>
    {
        ...
        public CartTransformMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public CartTransformMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public CartTransformMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
