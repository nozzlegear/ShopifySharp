...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class StoreCreditAccountExpirationTransactionQueryBuilder : FieldsQueryBuilderBase<StoreCreditAccountExpirationTransaction, StoreCreditAccountExpirationTransactionQueryBuilder>
    {
        ...
        public StoreCreditAccountExpirationTransactionQueryBuilder Account(Action<ShopifySharp.GraphQL.QueryBuilders.Types.StoreCreditAccountQueryBuilder> build)
        {
        ...
        public StoreCreditAccountExpirationTransactionQueryBuilder Amount(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyV2QueryBuilder> build)
        {
        ...
        public StoreCreditAccountExpirationTransactionQueryBuilder BalanceAfterTransaction(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyV2QueryBuilder> build)
        {
        ...
        public StoreCreditAccountExpirationTransactionQueryBuilder CreditTransaction(Action<ShopifySharp.GraphQL.QueryBuilders.Types.StoreCreditAccountCreditTransactionQueryBuilder> build)
        {
