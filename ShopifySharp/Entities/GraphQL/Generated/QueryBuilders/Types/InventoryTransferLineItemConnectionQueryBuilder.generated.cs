...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class InventoryTransferLineItemConnectionQueryBuilder : FieldsQueryBuilderBase<InventoryTransferLineItemConnection, InventoryTransferLineItemConnectionQueryBuilder>
    {
        ...
        public InventoryTransferLineItemConnectionQueryBuilder Edges(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.InventoryTransferLineItemEdgeQueryBuilder> build)
        {
            var query = new Query<InventoryTransferLineItemEdge>("edges");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.InventoryTransferLineItemEdgeQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<InventoryTransferLineItemEdge>(query);
            return this;
        }

        public InventoryTransferLineItemConnectionQueryBuilder Nodes(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.InventoryTransferLineItemQueryBuilder> build)
        {
        ...
        public InventoryTransferLineItemConnectionQueryBuilder PageInfo(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.PageInfoQueryBuilder> build)
        {
