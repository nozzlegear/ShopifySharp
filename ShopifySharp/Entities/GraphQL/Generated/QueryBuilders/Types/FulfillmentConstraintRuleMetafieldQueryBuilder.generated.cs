...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class FulfillmentConstraintRuleMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, FulfillmentConstraintRuleMetafieldQueryBuilder>, IHasArguments<FulfillmentConstraintRuleMetafieldArgumentsBuilder>
    {
        ...
        public FulfillmentConstraintRuleMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public FulfillmentConstraintRuleMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public FulfillmentConstraintRuleMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
