...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class GiftCardDebitTransactionMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, GiftCardDebitTransactionMetafieldQueryBuilder>, IHasArguments<GiftCardDebitTransactionMetafieldArgumentsBuilder>
    {
        ...
        public GiftCardDebitTransactionMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public GiftCardDebitTransactionMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public GiftCardDebitTransactionMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
