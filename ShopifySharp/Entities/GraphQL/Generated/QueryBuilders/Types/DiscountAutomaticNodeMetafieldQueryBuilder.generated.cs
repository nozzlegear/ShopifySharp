...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class DiscountAutomaticNodeMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, DiscountAutomaticNodeMetafieldQueryBuilder>, IHasArguments<DiscountAutomaticNodeMetafieldArgumentsBuilder>
    {
        ...
        public DiscountAutomaticNodeMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public DiscountAutomaticNodeMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public DiscountAutomaticNodeMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
