...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class OrderMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, OrderMetafieldQueryBuilder>, IHasArguments<OrderMetafieldArgumentsBuilder>
    {
        ...
        public OrderMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public OrderMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public OrderMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
