...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class ReverseDeliveryLineItemConnectionQueryBuilder : FieldsQueryBuilderBase<ReverseDeliveryLineItemConnection, ReverseDeliveryLineItemConnectionQueryBuilder>
    {
        ...
        public ReverseDeliveryLineItemConnectionQueryBuilder Edges(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.ReverseDeliveryLineItemEdgeQueryBuilder> build)
        {
            var query = new Query<ReverseDeliveryLineItemEdge>("edges");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.ReverseDeliveryLineItemEdgeQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<ReverseDeliveryLineItemEdge>(query);
            return this;
        }

        public ReverseDeliveryLineItemConnectionQueryBuilder Nodes(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.ReverseDeliveryLineItemQueryBuilder> build)
        {
        ...
        public ReverseDeliveryLineItemConnectionQueryBuilder PageInfo(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.PageInfoQueryBuilder> build)
        {
