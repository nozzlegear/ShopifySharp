...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class ArticleMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, ArticleMetafieldQueryBuilder>, IHasArguments<ArticleMetafieldArgumentsBuilder>
    {
        ...
        public ArticleMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public ArticleMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public ArticleMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
