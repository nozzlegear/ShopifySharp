...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class GiftCardCreditTransactionMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, GiftCardCreditTransactionMetafieldQueryBuilder>, IHasArguments<GiftCardCreditTransactionMetafieldArgumentsBuilder>
    {
        ...
        public GiftCardCreditTransactionMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public GiftCardCreditTransactionMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public GiftCardCreditTransactionMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
