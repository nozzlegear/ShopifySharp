...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class HasMetafieldsMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, HasMetafieldsMetafieldQueryBuilder>, IHasArguments<HasMetafieldsMetafieldArgumentsBuilder>
    {
        ...
        public HasMetafieldsMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public HasMetafieldsMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public HasMetafieldsMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
