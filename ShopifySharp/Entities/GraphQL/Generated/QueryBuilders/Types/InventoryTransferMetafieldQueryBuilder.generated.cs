...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class InventoryTransferMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, InventoryTransferMetafieldQueryBuilder>, IHasArguments<InventoryTransferMetafieldArgumentsBuilder>
    {
        ...
        public InventoryTransferMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public InventoryTransferMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public InventoryTransferMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
