...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class CheckoutBrandingColorsQueryBuilder : FieldsQueryBuilderBase<CheckoutBrandingColors, CheckoutBrandingColorsQueryBuilder>
    {
        ...
        public CheckoutBrandingColorsQueryBuilder Global(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CheckoutBrandingColorGlobalQueryBuilder> build)
        {
            var query = new Query<CheckoutBrandingColorGlobal>("global");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.CheckoutBrandingColorGlobalQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<CheckoutBrandingColorGlobal>(query);
            return this;
        }

        public CheckoutBrandingColorsQueryBuilder Schemes(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CheckoutBrandingColorSchemesQueryBuilder> build)
        {
            var query = new Query<CheckoutBrandingColorSchemes>("schemes");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.CheckoutBrandingColorSchemesQueryBuilder(query);
            build.Invoke(queryBuilder);
