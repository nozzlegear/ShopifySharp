...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class SellingPlanMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, SellingPlanMetafieldQueryBuilder>, IHasArguments<SellingPlanMetafieldArgumentsBuilder>
    {
        ...
        public SellingPlanMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public SellingPlanMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public SellingPlanMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
