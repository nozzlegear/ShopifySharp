...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class ShopifyPaymentsDisputeQueryBuilder : FieldsQueryBuilderBase<ShopifyPaymentsDispute, ShopifyPaymentsDisputeQueryBuilder>
    {
        ...
        public ShopifyPaymentsDisputeQueryBuilder Amount(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.MoneyV2QueryBuilder> build)
        {
        ...
        public ShopifyPaymentsDisputeQueryBuilder DisputeEvidence(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.ShopifyPaymentsDisputeEvidenceQueryBuilder> build)
        {
        ...
        public ShopifyPaymentsDisputeQueryBuilder Order(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.OrderQueryBuilder> build)
        {
        ...
        public ShopifyPaymentsDisputeQueryBuilder ReasonDetails(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.ShopifyPaymentsDisputeReasonDetailsQueryBuilder> build)
        {
            var query = new Query<ShopifyPaymentsDisputeReasonDetails>("reasonDetails");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.ShopifyPaymentsDisputeReasonDetailsQueryBuilder(query);
            build.Invoke(queryBuilder);
