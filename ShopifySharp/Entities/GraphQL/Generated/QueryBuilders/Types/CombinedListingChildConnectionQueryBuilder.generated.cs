...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class CombinedListingChildConnectionQueryBuilder : FieldsQueryBuilderBase<CombinedListingChildConnection, CombinedListingChildConnectionQueryBuilder>
    {
        ...
        public CombinedListingChildConnectionQueryBuilder Edges(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.CombinedListingChildEdgeQueryBuilder> build)
        {
            var query = new Query<CombinedListingChildEdge>("edges");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.CombinedListingChildEdgeQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<CombinedListingChildEdge>(query);
            return this;
        }

        public CombinedListingChildConnectionQueryBuilder Nodes(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.CombinedListingChildQueryBuilder> build)
        {
            var query = new Query<CombinedListingChild>("nodes");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.CombinedListingChildQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<CombinedListingChild>(query);
            return this;
        }

        public CombinedListingChildConnectionQueryBuilder PageInfo(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.PageInfoQueryBuilder> build)
        {
