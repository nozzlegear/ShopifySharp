...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class AdditionalFeeSaleQueryBuilder : FieldsQueryBuilderBase<AdditionalFeeSale, AdditionalFeeSaleQueryBuilder>
    {
        ...
        public AdditionalFeeSaleQueryBuilder AdditionalFee(Action<ShopifySharp.GraphQL.QueryBuilders.Types.SaleAdditionalFeeQueryBuilder> build)
        {
        ...
        public AdditionalFeeSaleQueryBuilder Taxes(Action<ShopifySharp.GraphQL.QueryBuilders.Types.SaleTaxQueryBuilder> build)
        {
        ...
        public AdditionalFeeSaleQueryBuilder TotalAmount(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public AdditionalFeeSaleQueryBuilder TotalDiscountAmountAfterTaxes(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public AdditionalFeeSaleQueryBuilder TotalDiscountAmountBeforeTaxes(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
        ...
        public AdditionalFeeSaleQueryBuilder TotalTaxAmount(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MoneyBagQueryBuilder> build)
        {
