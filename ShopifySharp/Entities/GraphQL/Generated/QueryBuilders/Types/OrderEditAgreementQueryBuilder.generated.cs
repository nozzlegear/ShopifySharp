...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class OrderEditAgreementQueryBuilder : FieldsQueryBuilderBase<OrderEditAgreement, OrderEditAgreementQueryBuilder>
    {
        ...
        public OrderEditAgreementQueryBuilder App(Action<ShopifySharp.GraphQL.QueryBuilders.Types.AppQueryBuilder> build)
        {
        ...
        public OrderEditAgreementQueryBuilder Sales(Action<ShopifySharp.GraphQL.QueryBuilders.Types.SaleConnectionQueryBuilder> build)
        {
        ...
        public OrderEditAgreementQueryBuilder User(Action<ShopifySharp.GraphQL.QueryBuilders.Types.StaffMemberQueryBuilder> build)
        {
