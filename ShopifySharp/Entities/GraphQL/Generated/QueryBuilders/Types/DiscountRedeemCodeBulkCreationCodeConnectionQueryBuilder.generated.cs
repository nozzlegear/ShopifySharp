...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class DiscountRedeemCodeBulkCreationCodeConnectionQueryBuilder : FieldsQueryBuilderBase<DiscountRedeemCodeBulkCreationCodeConnection, DiscountRedeemCodeBulkCreationCodeConnectionQueryBuilder>
    {
        ...
        public DiscountRedeemCodeBulkCreationCodeConnectionQueryBuilder Edges(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.DiscountRedeemCodeBulkCreationCodeEdgeQueryBuilder> build)
        {
            var query = new Query<DiscountRedeemCodeBulkCreationCodeEdge>("edges");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.DiscountRedeemCodeBulkCreationCodeEdgeQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<DiscountRedeemCodeBulkCreationCodeEdge>(query);
            return this;
        }

        public DiscountRedeemCodeBulkCreationCodeConnectionQueryBuilder Nodes(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.DiscountRedeemCodeBulkCreationCodeQueryBuilder> build)
        {
        ...
        public DiscountRedeemCodeBulkCreationCodeConnectionQueryBuilder PageInfo(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.PageInfoQueryBuilder> build)
        {
