...
namespace ShopifySharp.GraphQL.QueryBuilders.Types
{
    public sealed class DiscountNodeMetafieldQueryBuilder : FieldsQueryBuilderBase<Metafield, DiscountNodeMetafieldQueryBuilder>, IHasArguments<DiscountNodeMetafieldArgumentsBuilder>
    {
        ...
        public DiscountNodeMetafieldQueryBuilder SizeInBytes()
        {
            base.InnerQuery.AddField("sizeInBytes");
            return this;
        }

        public DiscountNodeMetafieldQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
        ...
        public DiscountNodeMetafieldQueryBuilder Owner(Action<HasMetafieldsInterfaceCasesBuilder> build)
        {
