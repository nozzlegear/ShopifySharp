...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Types
{
    public sealed class SubscriptionManualDiscountConnectionQueryBuilder : FieldsQueryBuilderBase<SubscriptionManualDiscountConnection, SubscriptionManualDiscountConnectionQueryBuilder>
    {
        ...
        public SubscriptionManualDiscountConnectionQueryBuilder Edges(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.SubscriptionManualDiscountEdgeQueryBuilder> build)
        {
            var query = new Query<SubscriptionManualDiscountEdge>("edges");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.SubscriptionManualDiscountEdgeQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<SubscriptionManualDiscountEdge>(query);
            return this;
        }

        public SubscriptionManualDiscountConnectionQueryBuilder Nodes(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.SubscriptionManualDiscountQueryBuilder> build)
        {
        ...
        public SubscriptionManualDiscountConnectionQueryBuilder PageInfo(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.PageInfoQueryBuilder> build)
        {
