...
public class MarketingEngagementQueryBuilder() : GraphQueryBuilder<MarketingEngagement>("query marketingEngagement")
{
    public MarketingEngagementQueryBuilder AddFieldAdSpend()
    {
        AddField("adSpend");
        return this;
    }
    ...
    public MarketingEngagementQueryBuilder AddFieldMarketingActivity()
    {
    ...
    public MarketingEngagementQueryBuilder AddFieldSales()
    {
        AddField("sales");
        return this;
    }
