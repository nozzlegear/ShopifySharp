...
public class BasicEventQueryBuilder() : GraphQueryBuilder<BasicEvent>("basicEvent")
{
    ...
    public BasicEventQueryBuilder AddFieldSubject(Func<HasEventsQueryBuilder, HasEventsQueryBuilder> build)
    {
        AddField<IHasEvents, HasEventsQueryBuilder>("subject", build);
        return this;
    }
