...
public class ShopPolicyQueryBuilder() : GraphQueryBuilder<ShopPolicy>("shopPolicy")
{
    ...
    public ShopPolicyQueryBuilder AddFieldTranslations(Func<TranslationQueryBuilder, TranslationQueryBuilder> build)
    {
