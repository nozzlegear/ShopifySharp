...
public class PriceRuleShareableUrlQueryBuilder() : GraphQueryBuilder<PriceRuleShareableUrl>("priceRuleShareableUrl")
{
    public PriceRuleShareableUrlQueryBuilder AddFieldTargetItemImage(Func<ImageQueryBuilder, ImageQueryBuilder> build)
    {
