...
public class SubscriptionBillingPolicyQueryBuilder() : GraphQueryBuilder<SubscriptionBillingPolicy>("query subscriptionBillingPolicy")
{
    public SubscriptionBillingPolicyQueryBuilder AddFieldAnchors()
    {
        AddField("anchors");
        return this;
    }
