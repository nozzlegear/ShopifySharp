...
public class TaxonomyCategoryQueryBuilder() : GraphQueryBuilder<TaxonomyCategory>("query taxonomyCategory")
{
    ...
    public TaxonomyCategoryQueryBuilder AddFieldAttributes()
    {
        AddField("attributes");
        return this;
    }
