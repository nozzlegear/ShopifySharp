...
public class SellingPlanFixedBillingPolicyQueryBuilder() : GraphQueryBuilder<SellingPlanFixedBillingPolicy>("sellingPlanFixedBillingPolicy")
{
    public SellingPlanFixedBillingPolicyQueryBuilder AddFieldCheckoutCharge(Func<SellingPlanCheckoutChargeQueryBuilder, SellingPlanCheckoutChargeQueryBuilder> build)
    {
        AddField<SellingPlanCheckoutCharge, SellingPlanCheckoutChargeQueryBuilder>("checkoutCharge", build);
        return this;
    }
