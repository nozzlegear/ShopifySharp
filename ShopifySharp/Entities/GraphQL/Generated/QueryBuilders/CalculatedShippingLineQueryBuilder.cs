...
public class CalculatedShippingLineQueryBuilder() : GraphQueryBuilder<CalculatedShippingLine>("query calculatedShippingLine")
{
    ...
    public CalculatedShippingLineQueryBuilder AddFieldPrice()
    {
        AddField("price");
        return this;
    }
