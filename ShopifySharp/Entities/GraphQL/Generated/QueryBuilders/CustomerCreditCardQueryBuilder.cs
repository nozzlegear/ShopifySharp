...
public class CustomerCreditCardQueryBuilder() : GraphQueryBuilder<CustomerCreditCard>("query customerCreditCard")
{
    public CustomerCreditCardQueryBuilder AddFieldBillingAddress()
    {
