...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Operations
{
    public sealed class PriceListsOperationQueryBuilder : FieldsQueryBuilderBase<PriceListConnection, PriceListsOperationQueryBuilder>, IGraphOperationQueryBuilder<PriceListConnection>
    {
        ...
        public PriceListsOperationQueryBuilder Edges(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.PriceListEdgeQueryBuilder> build)
        {
            var query = new Query<PriceListEdge>("edges");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.PriceListEdgeQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<PriceListEdge>(query);
            return this;
        }

        public PriceListsOperationQueryBuilder Nodes(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.PriceListQueryBuilder> build)
        {
        ...
        public PriceListsOperationQueryBuilder PageInfo(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.PageInfoQueryBuilder> build)
        {
