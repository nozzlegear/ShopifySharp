...
namespace ShopifySharp.GraphQL.QueryBuilders.Operations
{
    public sealed class ValidationOperationQueryBuilder : FieldsQueryBuilderBase<Validation, ValidationOperationQueryBuilder>, IGraphOperationQueryBuilder<Validation>
    {
        ...
        public ValidationOperationQueryBuilder ErrorHistory(Action<ShopifySharp.GraphQL.QueryBuilders.Types.FunctionsErrorHistoryQueryBuilder> build)
        {
        ...
        public ValidationOperationQueryBuilder Metafield(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldQueryBuilder> build)
        {
        ...
        public ValidationOperationQueryBuilder MetafieldDefinitions(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldDefinitionConnectionQueryBuilder> build)
        {
        ...
        public ValidationOperationQueryBuilder Metafields(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldConnectionQueryBuilder> build)
        {
        ...
        public ValidationOperationQueryBuilder ShopifyFunction(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ShopifyFunctionQueryBuilder> build)
        {
