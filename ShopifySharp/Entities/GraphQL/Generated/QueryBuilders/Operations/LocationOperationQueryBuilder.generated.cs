...
{
    public sealed class LocationOperationQueryBuilder : FieldsQueryBuilderBase<Location, LocationOperationQueryBuilder>, IGraphOperationQueryBuilder<Location>, IHasArguments<LocationArgumentsBuilder>
    {
        ...
        public LocationOperationQueryBuilder SetArguments(Action<LocationArgumentsBuilder> configure)
        {
        ...
        public LocationOperationQueryBuilder Address(Action<ShopifySharp.GraphQL.QueryBuilders.Types.LocationAddressQueryBuilder> build)
        {
        ...
        public LocationOperationQueryBuilder FulfillmentService(Action<ShopifySharp.GraphQL.QueryBuilders.Types.FulfillmentServiceQueryBuilder> build)
        {
        ...
        public LocationOperationQueryBuilder InventoryLevel(Action<ShopifySharp.GraphQL.QueryBuilders.Types.InventoryLevelQueryBuilder> build)
        {
        ...
        public LocationOperationQueryBuilder InventoryLevels(Action<ShopifySharp.GraphQL.QueryBuilders.Types.InventoryLevelConnectionQueryBuilder> build)
        {
        ...
        public LocationOperationQueryBuilder LocalPickupSettingsV2(Action<ShopifySharp.GraphQL.QueryBuilders.Types.DeliveryLocalPickupSettingsQueryBuilder> build)
        {
        ...
        public LocationOperationQueryBuilder Metafield(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldQueryBuilder> build)
        {
        ...
        public LocationOperationQueryBuilder MetafieldDefinitions(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldDefinitionConnectionQueryBuilder> build)
        {
        ...
        public LocationOperationQueryBuilder Metafields(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldConnectionQueryBuilder> build)
        {
        ...
        public LocationOperationQueryBuilder SuggestedAddresses(Action<ShopifySharp.GraphQL.QueryBuilders.Types.LocationSuggestedAddressQueryBuilder> build)
        {
