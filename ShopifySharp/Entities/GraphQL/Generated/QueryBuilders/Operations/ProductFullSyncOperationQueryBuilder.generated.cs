...
namespace ShopifySharp.GraphQL.QueryBuilders.Operations
{
    public sealed class ProductFullSyncOperationQueryBuilder : FieldsQueryBuilderBase<ProductFullSyncPayload, ProductFullSyncOperationQueryBuilder>, IGraphOperationQueryBuilder<ProductFullSyncPayload>
    {
        ...
        public ProductFullSyncOperationQueryBuilder UserErrors(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ProductFullSyncUserErrorQueryBuilder> build)
        {
            var query = new Query<ProductFullSyncUserError>("userErrors");
            var queryBuilder = new ShopifySharp.GraphQL.QueryBuilders.Types.ProductFullSyncUserErrorQueryBuilder(query);
