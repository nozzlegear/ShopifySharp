...
{
    public sealed class DeliveryCustomizationOperationQueryBuilder : FieldsQueryBuilderBase<DeliveryCustomization, DeliveryCustomizationOperationQueryBuilder>, IGraphOperationQueryBuilder<DeliveryCustomization>, IHasArguments<DeliveryCustomizationArgumentsBuilder>
    {
        ...
        public DeliveryCustomizationOperationQueryBuilder SetArguments(Action<DeliveryCustomizationArgumentsBuilder> configure)
        {
        ...
        public DeliveryCustomizationOperationQueryBuilder ErrorHistory(Action<ShopifySharp.GraphQL.QueryBuilders.Types.FunctionsErrorHistoryQueryBuilder> build)
        {
        ...
        public DeliveryCustomizationOperationQueryBuilder Metafield(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldQueryBuilder> build)
        {
        ...
        public DeliveryCustomizationOperationQueryBuilder MetafieldDefinitions(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldDefinitionConnectionQueryBuilder> build)
        {
        ...
        public DeliveryCustomizationOperationQueryBuilder Metafields(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldConnectionQueryBuilder> build)
        {
        ...
        public DeliveryCustomizationOperationQueryBuilder ShopifyFunction(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ShopifyFunctionQueryBuilder> build)
        {
