...
{
    public sealed class MetaobjectDefinitionOperationQueryBuilder : FieldsQueryBuilderBase<MetaobjectDefinition, MetaobjectDefinitionOperationQueryBuilder>, IGraphOperationQueryBuilder<MetaobjectDefinition>, IHasArguments<MetaobjectDefinitionArgumentsBuilder>
    {
        ...
        public MetaobjectDefinitionOperationQueryBuilder SetArguments(Action<MetaobjectDefinitionArgumentsBuilder> configure)
        {
            configure(this.Arguments);
            return this;
        }

        public MetaobjectDefinitionOperationQueryBuilder Access(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetaobjectAccessQueryBuilder> build)
        {
        ...
        public MetaobjectDefinitionOperationQueryBuilder Capabilities(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetaobjectCapabilitiesQueryBuilder> build)
        {
        ...
        public MetaobjectDefinitionOperationQueryBuilder CreatedAt()
        {
            base.InnerQuery.AddField("createdAt");
            return this;
        }

        public MetaobjectDefinitionOperationQueryBuilder CreatedByApp(Action<ShopifySharp.GraphQL.QueryBuilders.Types.AppQueryBuilder> build)
        {
        ...
        public MetaobjectDefinitionOperationQueryBuilder CreatedByStaff(Action<ShopifySharp.GraphQL.QueryBuilders.Types.StaffMemberQueryBuilder> build)
        {
        ...
        public MetaobjectDefinitionOperationQueryBuilder FieldDefinitions(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetaobjectFieldDefinitionQueryBuilder> build)
        {
        ...
        public MetaobjectDefinitionOperationQueryBuilder Metaobjects(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetaobjectConnectionQueryBuilder> build)
        {
        ...
        public MetaobjectDefinitionOperationQueryBuilder StandardTemplate(Action<ShopifySharp.GraphQL.QueryBuilders.Types.StandardMetaobjectDefinitionTemplateQueryBuilder> build)
        {
        ...
        public MetaobjectDefinitionOperationQueryBuilder UpdatedAt()
        {
