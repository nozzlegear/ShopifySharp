...
namespace ShopifySharp.GraphQL.Generated.QueryBuilders.Operations
{
    public sealed class ReverseDeliveryOperationQueryBuilder : FieldsQueryBuilderBase<ReverseDelivery, ReverseDeliveryOperationQueryBuilder>, IGraphOperationQueryBuilder<ReverseDelivery>
    {
        ...
        public ReverseDeliveryOperationQueryBuilder ReverseDeliveryLineItems(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.ReverseDeliveryLineItemConnectionQueryBuilder> build)
        {
            var query = new Query<ReverseDeliveryLineItemConnection>("reverseDeliveryLineItems");
            var queryBuilder = new ShopifySharp.GraphQL.Generated.QueryBuilders.Types.ReverseDeliveryLineItemConnectionQueryBuilder(query);
            build.Invoke(queryBuilder);
            base.InnerQuery.AddField<ReverseDeliveryLineItemConnection>(query);
            return this;
        }

        public ReverseDeliveryOperationQueryBuilder ReverseFulfillmentOrder(Action<ShopifySharp.GraphQL.Generated.QueryBuilders.Types.ReverseFulfillmentOrderQueryBuilder> build)
        {
