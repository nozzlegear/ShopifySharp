...
{
    public sealed class MetaobjectOperationQueryBuilder : FieldsQueryBuilderBase<Metaobject, MetaobjectOperationQueryBuilder>, IGraphOperationQueryBuilder<Metaobject>, IHasArguments<MetaobjectArgumentsBuilder>
    {
        ...
        public MetaobjectOperationQueryBuilder SetArguments(Action<MetaobjectArgumentsBuilder> configure)
        {
            configure(this.Arguments);
            return this;
        }

        public MetaobjectOperationQueryBuilder Capabilities(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetaobjectCapabilityDataQueryBuilder> build)
        {
        ...
        public MetaobjectOperationQueryBuilder CreatedBy(Action<ShopifySharp.GraphQL.QueryBuilders.Types.AppQueryBuilder> build)
        {
        ...
        public MetaobjectOperationQueryBuilder CreatedByApp(Action<ShopifySharp.GraphQL.QueryBuilders.Types.AppQueryBuilder> build)
        {
        ...
        public MetaobjectOperationQueryBuilder CreatedByStaff(Action<ShopifySharp.GraphQL.QueryBuilders.Types.StaffMemberQueryBuilder> build)
        {
        ...
        public MetaobjectOperationQueryBuilder Definition(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetaobjectDefinitionQueryBuilder> build)
        {
        ...
        public MetaobjectOperationQueryBuilder Field(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetaobjectFieldQueryBuilder> build)
        {
        ...
        public MetaobjectOperationQueryBuilder Fields(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetaobjectFieldQueryBuilder> build)
        {
        ...
        public MetaobjectOperationQueryBuilder ReferencedBy(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldRelationConnectionQueryBuilder> build)
        {
        ...
        public MetaobjectOperationQueryBuilder StaffMember(Action<ShopifySharp.GraphQL.QueryBuilders.Types.StaffMemberQueryBuilder> build)
        {
        ...
        public MetaobjectOperationQueryBuilder ThumbnailField(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetaobjectFieldQueryBuilder> build)
        {
