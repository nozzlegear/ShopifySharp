...
{
    public sealed class ArticleOperationQueryBuilder : FieldsQueryBuilderBase<Article, ArticleOperationQueryBuilder>, IGraphOperationQueryBuilder<Article>, IHasArguments<ArticleArgumentsBuilder>
    {
        ...
        public ArticleOperationQueryBuilder SetArguments(Action<ArticleArgumentsBuilder> configure)
        {
            configure(this.Arguments);
            return this;
        }

        public ArticleOperationQueryBuilder Author(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ArticleAuthorQueryBuilder> build)
        {
        ...
        public ArticleOperationQueryBuilder Blog(Action<ShopifySharp.GraphQL.QueryBuilders.Types.BlogQueryBuilder> build)
        {
        ...
        public ArticleOperationQueryBuilder Comments(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CommentConnectionQueryBuilder> build)
        {
        ...
        public ArticleOperationQueryBuilder CommentsCount(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CountQueryBuilder> build)
        {
        ...
        public ArticleOperationQueryBuilder Events(Action<ShopifySharp.GraphQL.QueryBuilders.Types.EventConnectionQueryBuilder> build)
        {
        ...
        public ArticleOperationQueryBuilder Image(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ImageQueryBuilder> build)
        {
        ...
        public ArticleOperationQueryBuilder Metafield(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldQueryBuilder> build)
        {
        ...
        public ArticleOperationQueryBuilder MetafieldDefinitions(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldDefinitionConnectionQueryBuilder> build)
        {
        ...
        public ArticleOperationQueryBuilder Metafields(Action<ShopifySharp.GraphQL.QueryBuilders.Types.MetafieldConnectionQueryBuilder> build)
        {
        ...
        public ArticleOperationQueryBuilder Translations(Action<ShopifySharp.GraphQL.QueryBuilders.Types.TranslationQueryBuilder> build)
        {
