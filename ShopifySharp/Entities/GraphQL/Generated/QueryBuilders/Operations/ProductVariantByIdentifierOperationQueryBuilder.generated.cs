...
{
    public sealed class ProductVariantByIdentifierOperationQueryBuilder : FieldsQueryBuilderBase<ProductVariant, ProductVariantByIdentifierOperationQueryBuilder>, IGraphOperationQueryBuilder<ProductVariant>, IHasArguments<ProductVariantByIdentifierArgumentsBuilder>
    {
        ...
        public ProductVariantByIdentifierOperationQueryBuilder SetArguments(Action<ProductVariantByIdentifierArgumentsBuilder> configure)
        {
        ...
        public ProductVariantByIdentifierOperationQueryBuilder AvailablePublicationsCount(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CountQueryBuilder> build)
        {
        ...
        public ProductVariantByIdentifierOperationQueryBuilder PublicationCount()
        {
        ...
        public ProductVariantByIdentifierOperationQueryBuilder PublishedOnChannel()
        {
        ...
        public ProductVariantByIdentifierOperationQueryBuilder PublishedOnCurrentChannel()
        {
        ...
        [Obsolete("Use `publishedOnPublication` instead.")]
        public ProductVariantByIdentifierOperationQueryBuilder PublishedOnCurrentPublication()
        {
            base.InnerQuery.AddField("publishedOnCurrentPublication");
            return this;
        }

        public ProductVariantByIdentifierOperationQueryBuilder PublishedOnPublication()
        {
        ...
        public ProductVariantByIdentifierOperationQueryBuilder ResourcePublications(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ResourcePublicationConnectionQueryBuilder> build)
        {
        ...
        public ProductVariantByIdentifierOperationQueryBuilder ResourcePublicationsCount(Action<ShopifySharp.GraphQL.QueryBuilders.Types.CountQueryBuilder> build)
        {
        ...
        public ProductVariantByIdentifierOperationQueryBuilder ResourcePublicationsV2(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ResourcePublicationV2ConnectionQueryBuilder> build)
        {
        ...
        public ProductVariantByIdentifierOperationQueryBuilder UnpublishedChannels(Action<ShopifySharp.GraphQL.QueryBuilders.Types.ChannelConnectionQueryBuilder> build)
        {
        ...
        public ProductVariantByIdentifierOperationQueryBuilder UnpublishedPublications(Action<ShopifySharp.GraphQL.QueryBuilders.Types.PublicationConnectionQueryBuilder> build)
        {
