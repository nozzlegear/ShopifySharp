...
public class ShopFeaturesQueryBuilder() : GraphQueryBuilder<ShopFeatures>("shopFeatures")
{
    ...
    public ShopFeaturesQueryBuilder AddFieldBundles(Func<BundlesFeatureQueryBuilder, BundlesFeatureQueryBuilder> build)
    {
        AddField<BundlesFeature, BundlesFeatureQueryBuilder>("bundles", build);
        return this;
    }
    ...
    public ShopFeaturesQueryBuilder AddFieldCartTransform(Func<CartTransformFeatureQueryBuilder, CartTransformFeatureQueryBuilder> build)
    {
        AddField<CartTransformFeature, CartTransformFeatureQueryBuilder>("cartTransform", build);
        return this;
    }
