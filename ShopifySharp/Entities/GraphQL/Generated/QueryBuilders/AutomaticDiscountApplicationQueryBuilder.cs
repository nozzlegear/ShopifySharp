...
public class AutomaticDiscountApplicationQueryBuilder() : GraphQueryBuilder<AutomaticDiscountApplication>("query automaticDiscountApplication")
{
    ...
    public AutomaticDiscountApplicationQueryBuilder AddFieldValue()
    {
        AddField("value");
        return this;
    }
