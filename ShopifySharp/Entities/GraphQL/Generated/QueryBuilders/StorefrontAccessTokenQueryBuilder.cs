...
public class StorefrontAccessTokenQueryBuilder() : GraphQueryBuilder<StorefrontAccessToken>("query storefrontAccessToken")
{
    public StorefrontAccessTokenQueryBuilder AddFieldAccessScopes()
    {
