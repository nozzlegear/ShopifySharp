...
public class GenericFileQueryBuilder() : GraphQueryBuilder<GenericFile>("query genericFile")
{
    ...
    public GenericFileQueryBuilder AddFieldFileErrors()
    {
        AddField("fileErrors");
        return this;
    }
    ...
    public GenericFileQueryBuilder AddFieldPreview()
    {
        AddField("preview");
        return this;
    }
