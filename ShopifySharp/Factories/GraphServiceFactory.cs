...
public class GraphServiceFactory(IServiceProvider? serviceProvider) : IServiceFactory<IGraphService>
{
    [Obsolete]
    ...
    {
        IGraphService service = new GraphService(credentials, null, serviceProvider);
