...
public class CollectServiceFactory : ICollectServiceFactory
{
    ...
    public CollectServiceFactory(IRequestExecutionPolicy? requestExecutionPolicy, IShopifyDomainUtility? shopifyDomainUtility = null)
    {
        _shopifyDomainUtility = shopifyDomainUtility;
        _requestExecutionPolicy = requestExecutionPolicy;
    }

    public CollectServiceFactory(IServiceProvider serviceProvider)
    {
