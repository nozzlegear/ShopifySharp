...
public class FulfillmentServiceFactory : IFulfillmentServiceFactory
{
    ...
    public FulfillmentServiceFactory(IRequestExecutionPolicy? requestExecutionPolicy, IShopifyDomainUtility? shopifyDomainUtility = null)
    {
        _shopifyDomainUtility = shopifyDomainUtility;
        _requestExecutionPolicy = requestExecutionPolicy;
    }

    public FulfillmentServiceFactory(IServiceProvider serviceProvider)
    {
