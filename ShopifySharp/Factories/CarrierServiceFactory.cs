...
public class CarrierServiceFactory(IDependencyContainer? dependencyContainer = null) : IServiceFactory<ICarrierService>
{
    [Obsolete("This constructor is deprecated and will be removed in a future version of ShopifySharp.")]
    public CarrierServiceFactory(IRequestExecutionPolicy? requestExecutionPolicy = null, IShopifyDomainUtility? shopifyDomainUtility = null)
    ...
    public virtual ICarrierService Create(ShopifyApiCredentials credentials)
    {
        ...
        ICarrierService service = shopifyDomainUtility is null ? new CarrierService(credentials.ShopDomain, credentials.AccessToken) : new CarrierService(credentials.ShopDomain, credentials.AccessToken, shopifyDomainUtility);
