...
public class CollectionServiceFactory : ICollectionServiceFactory
{
    ...
    public CollectionServiceFactory(IRequestExecutionPolicy? requestExecutionPolicy, IShopifyDomainUtility? shopifyDomainUtility = null)
    {
        _shopifyDomainUtility = shopifyDomainUtility;
        _requestExecutionPolicy = requestExecutionPolicy;
    }

    public CollectionServiceFactory(IServiceProvider serviceProvider)
    {
    ...
    {
        ICollectionService service = _serviceProvider is not null
            ? new CollectionService(credentials, _serviceProvider)
            : new CollectionService(credentials, _shopifyDomainUtility);
