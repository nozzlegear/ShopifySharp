...
public class ThemeServiceFactory : IThemeServiceFactory
{
    ...
    public ThemeServiceFactory(IRequestExecutionPolicy? requestExecutionPolicy, IShopifyDomainUtility? shopifyDomainUtility = null)
    {
        _shopifyDomainUtility = shopifyDomainUtility;
        _requestExecutionPolicy = requestExecutionPolicy;
    }

    public ThemeServiceFactory(IServiceProvider serviceProvider)
    {
    ...
    {
        IThemeService service = _serviceProvider is not null
            ? new ThemeService(credentials, _serviceProvider)
            : new ThemeService(credentials, _shopifyDomainUtility);
