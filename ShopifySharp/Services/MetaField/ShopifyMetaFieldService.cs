...
namespace ShopifySharp
{
    ...
    public class ShopifyMetaFieldService : ShopifyService
    {
        ...
        public async Task<int> CountAsync(long? resourceId, string resourceType = null, ShopifyMetaFieldFilterOptions options = null)
        {
            ...
            {
                reqPath = "{0}/{1}/metafields/count.json".FormatWith(resourceType, resourceId);
            }
        ...
        public async Task<IEnumerable<ShopifyMetaField>> ListAsync(long? resourceId, string resourceType = null, ShopifyMetaFieldFilterOptions options = null)
        {
            ...
            if (resourceType != null && resourceId != null)
            {
                reqPath = "{0}/{1}/metafields.json".FormatWith(resourceType, resourceId);
            }
        ...
        {
            IRestRequest req = RequestEngine.CreateRequest("metafields/{0}.json".FormatWith(metafieldId), Method.GET, "metafields");
        ...
        {
            IRestRequest req = RequestEngine.CreateRequest("metafields/{0}.json".FormatWith(metafield.Id.Value), Method.PUT, "metafield");
        ...
        {
            IRestRequest req = RequestEngine.CreateRequest("metafields/{0}.json".FormatWith(metafieldId), Method.DELETE);
