...
namespace ShopifySharp
{
    public static class AuthorizationService
    {
        ...
        {
            return (await Authorize2(code, myShopifyUrl, shopifyApiKey, shopifySecretKey)).AccessToken;
        }
        ...
        public static async Task<AuthorizationResult> Authorize2(string code, string myShopifyUrl, string shopifyApiKey, string shopifySecretKey)
        {
