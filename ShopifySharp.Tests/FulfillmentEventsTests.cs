...
public class FulfillmentEventsTests : IClassFixture<FulfillmentEventsTestsFixture>
{
    private FulfillmentEventsTestsFixture Fixture { get; }

    public FulfillmentEventsTests(FulfillmentEventsTestsFixture fixture)
    {
...
public class FulfillmentEventsTestsFixture : IAsyncLifetime
{
