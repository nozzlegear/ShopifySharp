...
public class DiscountCodeTests : IClassFixture<DiscountCodesTestsFixture>
{
    private DiscountCodesTestsFixture Fixture { get; }

    public DiscountCodeTests(DiscountCodesTestsFixture fixture)
    {
...
public class DiscountCodesTestsFixture : IAsyncLifetime
{
