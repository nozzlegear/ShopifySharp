...
public class GiftCardAdjustmentTests : IClassFixture<GiftCardAdjustmentTestsFixture>
{
    private GiftCardAdjustmentTestsFixture Fixture { get; }

    public GiftCardAdjustmentTests(GiftCardAdjustmentTestsFixture fixture)
    {
...
public class GiftCardAdjustmentTestsFixture: IAsyncLifetime
{
