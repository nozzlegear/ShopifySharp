...
public class FulfillmentTests : IClassFixture<FulfillmentTestsFixture>
{
    private FulfillmentTestsFixture Fixture { get; }

    public FulfillmentTests(FulfillmentTestsFixture fixture)
    {
...
public class FulfillmentTestsFixture : IAsyncLifetime
{
