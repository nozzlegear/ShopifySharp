...
public class FulfillmentOrderTests : IClassFixture<FulfillmentOrderTestsFixture>
{
    private FulfillmentOrderTestsFixture Fixture { get; }

    public FulfillmentOrderTests(FulfillmentOrderTestsFixture fixture)
    {
...
public class FulfillmentOrderTestsFixture : IAsyncLifetime
{
