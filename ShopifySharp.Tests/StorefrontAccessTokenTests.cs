...
public class StorefrontAccessTokenTests : IClassFixture<StorefrontAccessTokenTestsFixture>
{
    private StorefrontAccessTokenTestsFixture Fixture { get; }
        
    public StorefrontAccessTokenTests(StorefrontAccessTokenTestsFixture fixture)
    {
        Fixture = fixture;
    }
...
public class StorefrontAccessTokenTestsFixture : IAsyncLifetime
{
