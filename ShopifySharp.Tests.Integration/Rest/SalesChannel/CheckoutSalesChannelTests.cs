...
namespace ShopifySharp.Tests.Integration.Rest.SalesChannel;

[Trait("Category", "CheckoutSalesChannel")]
public class CheckoutSalesChannelTests: IClassFixture<CheckoutSalesChannelFixture>
{
    private CheckoutSalesChannelFixture Fixture { get; }

    public CheckoutSalesChannelTests(CheckoutSalesChannelFixture fixture)
    {
...
public class CheckoutSalesChannelFixture : IAsyncLifetime
{
